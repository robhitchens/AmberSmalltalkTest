...
var $pkg = $core.addPackage("Playing");
...
$core.addClass("Playing", $globals.Object, "Playing");
//>>excludeStart("ide", pragmas.excludeIdeData);
$globals.Playing.comment="This class is just a place to mess around with and figure out the Amber smalltalk environment and Helios IDE and try to understand how it works";
//>>excludeEnd("ide");
$core.addMethod(
$core.method({
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: ["message"],
source: "showMessage: message\x0a\x09Transcript show: message",
referencedClasses: ["Transcript"],
//>>excludeEnd("ide");
pragmas: [],
messageSends: ["show:"]
}, function ($methodClass){ return function (message){
var self=this,$self=this;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
$recv($globals.Transcript)._show_(message);
return self;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
}, function($ctx1) {$ctx1.fill(self,"showMessage:",{message:message})});
//>>excludeEnd("ctx");
}; }),
$globals.Playing);
