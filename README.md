...
## Use Playing library in your project

**DELETE THIS PARAGRAPH, IF Playing IS A LIBRARY. DELETE WHOLE THIS SECTION IF Playing IS AN APP, NOT A LIBRARY.**
...
```sh
npm install Playing --save
grunt devel
amber serve
```

Go to `http://localhost:4000/` in your browser and
in all packages that use Playing,
add `'amber-test/Playing'` to the package imports,
